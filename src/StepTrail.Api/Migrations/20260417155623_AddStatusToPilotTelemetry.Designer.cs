...
namespace StepTrail.Api.Migrations
{
    ...
    [Migration("20260417155623_AddStatusToPilotTelemetry")]
    partial class AddStatusToPilotTelemetry
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StepTrail.Shared.Entities.AlertDeliveryRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("AlertRecordId")
                        .HasColumnType("uuid")
                        .HasColumnName("alert_record_id");
                    ...
                    b.ToTable("alert_delivery_records", (string)null);
                });

            modelBuilder.Entity("StepTrail.Shared.Entities.AlertRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("StepTrail.Shared.Entities.AlertDeliveryRecord", b =>
                {
                    b.HasOne("StepTrail.Shared.Entities.AlertRecord", "AlertRecord")
                        .WithMany("Deliveries")
